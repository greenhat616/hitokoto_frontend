...
<a-row style="margin-top:5em; margin-bottom: 5em;">
  <a-col :xs="{span: 24, offset: 0}" :sm="{span: 24, offset: 0}" :md="{span: 16, offset:4}">
    <div class="shadow-background" :style="!is_load ? 'height: 24em;' : ''">
      <a-row v-if="is_load" class="full-height markdown-padding">
        <div class="content-head">
          <h1>接口说明</h1>
          <h2>特别赞助</h2>
          <p><a target="_blank" href="https://www.dogecloud.com/"><img src="https://piccdn.freejishu.com/images/2019/07/21/PnY445.png" width="250" /></a></p>
      ...
      <a-row v-if="!is_load" class="full-height" type="flex" align="middle" justify="center">
        <a-icon type="loading" :style="{fontSize: '3em'}"></a-icon>
      </a-row>
    </div>
  </a-col>
</a-row>
